        ...
        <div className='flex flex-col items-center px-6 mt-14 h-full'>
            ...
            <div className=' flex flex-row justify-center gap-3'>
                <div className='flex flex-col justify-start gap-3 w-[50%]'>
                    <img ref={(el) => (artRef.current[1] = el)} className='object-cover' src="src\assets\art-1.jpg" alt="" />
                    ...
                    <img ref={(el) => (artRef.current[11] = el)} className='object-cover' src="src\assets\art-6.jpg" alt="" />
                </div>
