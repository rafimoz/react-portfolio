...
const ServiceItem = ({ title, imageUrl, description, index }) => {
    ...
    return (
        <div
            ...
            ref={parentDivRef}
        >
            <h3 className='sm:text-5xl text-2xl z-10 font-bigshoulders group-hover:font-normal font-extralight transition-all duration-200'>
                {title}
            </h3>

            <svg
                className={`sm:h-[60px] h-[40px] rounded-full cursor-pointer fill-current border ${
                    dark
                        ? 'text-primary border-primary group-hover:bg-primary/10'
                        : 'text-secondary border-secondary group-hover:bg-secondary/10'
                } `}
                viewBox="0 0 100 100"
            ...
            <p
                ...
                className={`absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 sm:text-sm text-[8px] w-20 sm:w-80 line-clamp-2 overflow-hidden ${
                    dark ? 'text-primary/70' : 'text-secondary/70'
                }`}
            >
                {description}
            </p>
...
const Services = () => {
    ...
    return (
        <section className='w-full overflow-hidden sm:px-8 px-4 my-20'>
