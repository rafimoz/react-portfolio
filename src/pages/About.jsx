    ...
    <section id='about' ref={containerRef} className="w-full h-fit flex justify-center items-center overflow-hidden sm:px-8 px-4">
      <div className="my-40 grid grid-cols-[1fr_4fr] gap-4 sm:grid-cols-[1fr_2fr]">
        ...
        <div className="flex flex-col justify-end items-end gap-2" >
          ...
          <a href="https://www.instagram.com/raafi.mozumder/" target="_blank" rel="noopener noreferrer" className={`scale-75 sm:scale-100 w-16 rounded-full fill-current`}>
          ...
          <a href="https://dribbble.com/rafimozumder" download target="_blank" rel="noopener noreferrer" className={`scale-75 sm:scale-100 w-16 rounded-full fill-current`}>
            <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
